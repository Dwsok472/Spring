...
import com.dw.firstapp.repository.iface.CustomerRepository;
import com.dw.firstapp.repository.jdbc.CustomerJdbcRepository;
...
public class CustomerService {
    ...
    public List<Customer> getCustomersWithHighMileThanAvg() {
        return customerRepository.getCustomersWithHighMileageThanAvg();
    }
