...
public class EmployeeJdbcRepository implements EmployeeRepository {
    ...
    public List<Employee> getAllemployee() {
        ...
        try (
            ...
            while (resultSet.next()) {
                ...
                employee.setEmployeeClass(resultSet.getString("직위"));
                ...
                employee.setAdress(resultSet.getString("주소"));
    ...
    public Employee saveEmployee(Employee employee) {
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
            ...
            pstmt.setString(4, employee.getEmployeeClass());
            pstmt.setString(5, employee.getGender());
            pstmt.setString(6, String.valueOf(employee.getBirthDate()));
            pstmt.setString(7, String.valueOf(employee.getHireDate()));
            pstmt.setString(8, employee.getAdress());
